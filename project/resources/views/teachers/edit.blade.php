    ...
    <div class="flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                <div class="p-8">
                    <h3 class="text-xl font-bold text-gray-900 mb-6">Редактировать преподавателя</h3>
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input type="text" name="name" id="name" 
                                       value="{{ old('name', $teacher->first_name) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="lastname" id="lastname" 
                                       value="{{ old('lastname', $teacher->last_name) }}"
